...
CREATE TABLE `alumnos_curso` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `alumnos_curso_UN` (`id_alumno`,`id_curso`),
...
INSERT INTO `alumnos_curso` VALUES (1,1,1),(2,1,2),(3,2,1),(4,2,3),(5,3,2),(6,3,3),(7,4,1),(24,4,2);
...
-- Dump completed on 2020-09-20 23:57:18

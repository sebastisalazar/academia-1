...
/**
 * Servlet Filter implementation class PrivadoAlumnoFilter
 */
@WebFilter(dispatcherTypes = {
				...
				DispatcherType.ERROR
					...
					, urlPatterns = { "/privado/alumno.jsp" })
public class PrivadoAlumnoFilter implements Filter {

    /**
     * Default constructor. 
     */
    public PrivadoAlumnoFilter() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		}else if (u.getRol()==Usuario.ROL_PROFESOR){
